...
- [webonyx/graphql-php](https://github.com/webonyx/graphql-php) ([v15.14.0](https://github.com/webonyx/graphql-php/releases/tag/v15.14.0), today) - PHP implementation of the GraphQL specification based on the reference implementation in JavaScript
