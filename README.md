...
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([2.4.0](https://github.com/hasura-extra/hasura-extra/releases/tag/2.4.0), 3 days ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
...
- [spawnia/sailor](https://github.com/spawnia/sailor) ([v0.18.2](https://github.com/spawnia/sailor/releases/tag/v0.18.2), 3 weeks ago) - A typesafe GraphQL client for PHP
