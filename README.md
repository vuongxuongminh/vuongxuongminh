...
- [hasura-extra/symfony-app](https://github.com/hasura-extra/symfony-app) - Symfony application template (boilerplate) to build the modern web APIs with Hasura graphql engine. (3 weeks ago)
- [hasura-extra/laravel-app](https://github.com/hasura-extra/laravel-app) - Laravel application template (boilerplate) to build the modern web APIs with Hasura graphql engine. (3 weeks ago)
- [hasura-extra/laravel](https://github.com/hasura-extra/laravel) - [READ-ONLY] Laravel package to build the modern web APIs with Hasura graphql engine. (4 weeks ago)
...
- [hasura-extra/graphqlite-bridge](https://github.com/hasura-extra/graphqlite-bridge) - [READ-ONLY] Provide integration for GraphQLite with Hasura Extra packages. (1 month ago)
- [hasura-extra/auth-hook](https://github.com/hasura-extra/auth-hook) - [READ-ONLY] PSR-15 server request handle Hasura webhook authentication. (1 month ago)
...
- [hasura-extra/sailor-bridge](https://github.com/hasura-extra/sailor-bridge) - [READ-ONLY] Provide integration for Sailor graphql client with Hasura Extra packages. (1 month ago)
...
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([2.1.2](https://github.com/hasura-extra/hasura-extra/releases/tag/2.1.2), 1 week ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
- [hasura-extra/laravel-app](https://github.com/hasura-extra/laravel-app) ([v1.0.0](https://github.com/hasura-extra/laravel-app/releases/tag/v1.0.0), 3 weeks ago) - Laravel application template (boilerplate) to build the modern web APIs with Hasura graphql engine.
- [hasura-extra/symfony-app](https://github.com/hasura-extra/symfony-app) ([v1.0.4](https://github.com/hasura-extra/symfony-app/releases/tag/v1.0.4), 3 weeks ago) - Symfony application template (boilerplate) to build the modern web APIs with Hasura graphql engine.
...
- [hasura-extra/hasura-bundle](https://github.com/hasura-extra/hasura-bundle) ([v1.1.0](https://github.com/hasura-extra/hasura-bundle/releases/tag/v1.1.0), 2 months ago) - Symfony bundle to help handle Hasura action, event, metadata and more.
