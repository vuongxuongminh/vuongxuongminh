...
- [hasura-extra/graphql-scalars](https://github.com/hasura-extra/graphql-scalars) - [READ-ONLY] Provides graphql scalar types to compatible with Hasura graphql engine. (1 day ago)
...
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([3.3.0](https://github.com/hasura-extra/hasura-extra/releases/tag/3.3.0), 1 day ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
- [apache/superset](https://github.com/apache/superset) ([2.0.1rc5](https://github.com/apache/superset/releases/tag/2.0.1rc5), 1 week ago) - Apache Superset is a Data Visualization and Data Exploration Platform
