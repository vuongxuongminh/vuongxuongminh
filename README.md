...
- [hasura-extra/symfony-app](https://github.com/hasura-extra/symfony-app) ([v2.0.0](https://github.com/hasura-extra/symfony-app/releases/tag/v2.0.0), 2 days ago) - Symfony application template (boilerplate) to build the modern web APIs with Hasura graphql engine.
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([3.1.0](https://github.com/hasura-extra/hasura-extra/releases/tag/3.1.0), 3 days ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
- [apache/superset](https://github.com/apache/superset) ([1.5.2rc3](https://github.com/apache/superset/releases/tag/1.5.2rc3), 4 days ago) - Apache Superset is a Data Visualization and Data Exploration Platform
