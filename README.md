...
- [php-istio/jwt-payload-extractor](https://github.com/php-istio/jwt-payload-extractor) ([v1.0.0](https://github.com/php-istio/jwt-payload-extractor/releases/tag/v1.0.0), 2 days ago) - The library help to extract trusted JWT payload from request forwarded by Istio sidecar.
