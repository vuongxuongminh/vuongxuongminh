...
- [hasura-extra/laravel](https://github.com/hasura-extra/laravel) - [READ-ONLY] Laravel package to build the modern web APIs with Hasura graphql engine. (6 days ago)
...
- [hasura-extra/graphqlite-bridge](https://github.com/hasura-extra/graphqlite-bridge) - [READ-ONLY] Provide integration for GraphQLite with Hasura Extra packages. (4 weeks ago)
...
- [hasura-extra/symfony-app](https://github.com/hasura-extra/symfony-app) ([v1.0.3](https://github.com/hasura-extra/symfony-app/releases/tag/v1.0.3), 1 week ago) - Symfony application template (boilerplate) to build the modern web APIs with Hasura graphql engine.
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([v2.0.0](https://github.com/hasura-extra/hasura-extra/releases/tag/v2.0.0), 2 weeks ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
