...
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([3.2.0](https://github.com/hasura-extra/hasura-extra/releases/tag/3.2.0), 5 days ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
...
- [spawnia/sailor](https://github.com/spawnia/sailor) ([v0.25.0](https://github.com/spawnia/sailor/releases/tag/v0.25.0), 2 weeks ago) - A typesafe GraphQL client for PHP
