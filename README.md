...
- [php-istio/jwt-authentication-bundle](https://github.com/php-istio/jwt-authentication-bundle) ([v1.0.0](https://github.com/php-istio/jwt-authentication-bundle/releases/tag/v1.0.0), 1 day ago) - Symfony bundle help to authenticate request forwarded by Istio sidecar.
- [php-istio/jwt-payload-extractor](https://github.com/php-istio/jwt-payload-extractor) ([v1.0.0](https://github.com/php-istio/jwt-payload-extractor/releases/tag/v1.0.0), 4 days ago) - The library help to extract trusted JWT payload from request forwarded by Istio sidecar.
