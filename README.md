...
- [hasura-extra/bundle](https://github.com/hasura-extra/bundle) - [READ-ONLY] Symfony bundle to build the modern web APIs with Hasura graphql engine. (4 days ago)
...
- [hasura-extra/sailor-bridge](https://github.com/hasura-extra/sailor-bridge) - [READ-ONLY] Provide integration for Sailor graphql client with Hasura Extra packages. (2 weeks ago)
...
- [hasura-extra/metadata](https://github.com/hasura-extra/metadata) - [READ-ONLY] library to help mange Hasura metadata. (3 weeks ago)
...
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([helm-chart-2.1.0](https://github.com/hasura-extra/hasura-extra/releases/tag/helm-chart-2.1.0), 6 days ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
