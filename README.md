...
- [spawnia/sailor](https://github.com/spawnia/sailor) - A typesafe GraphQL client for PHP (today)
...
- [spawnia/sailor](https://github.com/spawnia/sailor) ([v0.17.1](https://github.com/spawnia/sailor/releases/tag/v0.17.1), today) - A typesafe GraphQL client for PHP
...
- [hasura-extra/symfony-app](https://github.com/hasura-extra/symfony-app) ([1.2.0](https://github.com/hasura-extra/symfony-app/releases/tag/1.2.0), 5 days ago) - Symfony application template (boilerplate) to build the modern web APIs with Hasura graphql engine.
- [hasura-extra/laravel-app](https://github.com/hasura-extra/laravel-app) ([1.2.0](https://github.com/hasura-extra/laravel-app/releases/tag/1.2.0), 5 days ago) - Laravel application template (boilerplate) to build the modern web APIs with Hasura graphql engine.
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([2.3.0](https://github.com/hasura-extra/hasura-extra/releases/tag/2.3.0), 5 days ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
