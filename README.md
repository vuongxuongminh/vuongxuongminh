...
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([5.0.0](https://github.com/hasura-extra/hasura-extra/releases/tag/5.0.0), 2 weeks ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
- [doctrine/orm](https://github.com/doctrine/orm) ([2.17.2](https://github.com/doctrine/orm/releases/tag/2.17.2), 4 weeks ago) - Doctrine Object Relational Mapper (ORM)
