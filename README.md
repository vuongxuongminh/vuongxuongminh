...
- [symplify/symplify](https://github.com/symplify/symplify) - Do you use Symfony, Coding Standards, maintain PHP packages, monorepo, local packages, static websites and most importantly... are you extreemely lazy? You&#39;ll love the candies you find here! :) (2 days ago)
...
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([v2.0.0](https://github.com/hasura-extra/hasura-extra/releases/tag/v2.0.0), 2 days ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
