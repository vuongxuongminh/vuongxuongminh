...
- [hasura-extra/graphql-scalars](https://github.com/hasura-extra/graphql-scalars) - [READ-ONLY] Provides graphql scalar types to compatible with Hasura graphql engine. (6 days ago)
...
- [apache/superset](https://github.com/apache/superset) ([2.0.1](https://github.com/apache/superset/releases/tag/2.0.1), 1 day ago) - Apache Superset is a Data Visualization and Data Exploration Platform
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([3.3.0](https://github.com/hasura-extra/hasura-extra/releases/tag/3.3.0), 6 days ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
