...
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([helm-chart-2.7.0](https://github.com/hasura-extra/hasura-extra/releases/tag/helm-chart-2.7.0), 1 day ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
- [apache/superset](https://github.com/apache/superset) ([2.0.1rc2](https://github.com/apache/superset/releases/tag/2.0.1rc2), 2 days ago) - Apache Superset is a Data Visualization and Data Exploration Platform
- [spawnia/sailor](https://github.com/spawnia/sailor) ([v0.26.0](https://github.com/spawnia/sailor/releases/tag/v0.26.0), 5 days ago) - A typesafe GraphQL client for PHP
