...
- [php-istio/jwt-authentication-bundle](https://github.com/php-istio/jwt-authentication-bundle) ([v1.0.1](https://github.com/php-istio/jwt-authentication-bundle/releases/tag/v1.0.1), today) - Symfony bundle help to authenticate request forwarded by Istio sidecar.
