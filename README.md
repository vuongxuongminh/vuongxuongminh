...
- [hasura-extra/auth-hook](https://github.com/hasura-extra/auth-hook) - [READ-ONLY] PSR-15 server request handle Hasura webhook authentication. (3 days ago)
- [php-istio/jwt-authentication-bundle](https://github.com/php-istio/jwt-authentication-bundle) - Symfony bundle help to authenticate request forwarded by Istio sidecar. (4 days ago)
- [php-istio/jwt-payload-extractor](https://github.com/php-istio/jwt-payload-extractor) - The library help to extract trusted JWT payload from request forwarded by Istio sidecar. (4 days ago)
- [hasura-extra/sailor-bridge](https://github.com/hasura-extra/sailor-bridge) - [READ-ONLY] Provide integration for Sailor graphql client with Hasura Extra packages. (4 days ago)
- [hasura-extra/event-dispatcher](https://github.com/hasura-extra/event-dispatcher) - [READ-ONLY] PSR-15 server request handle to help dispatch events triggered by Hasura via PSR-14 event dispatcher. (6 days ago)
...
- [php-istio/jwt-authentication-bundle](https://github.com/php-istio/jwt-authentication-bundle) ([v1.1.0](https://github.com/php-istio/jwt-authentication-bundle/releases/tag/v1.1.0), 4 days ago) - Symfony bundle help to authenticate request forwarded by Istio sidecar.
- [php-istio/jwt-payload-extractor](https://github.com/php-istio/jwt-payload-extractor) ([v1.1.1](https://github.com/php-istio/jwt-payload-extractor/releases/tag/v1.1.1), 4 days ago) - The library help to extract trusted JWT payload from request forwarded by Istio sidecar.
