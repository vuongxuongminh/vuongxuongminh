...
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([helm-chart-2.2.0](https://github.com/hasura-extra/hasura-extra/releases/tag/helm-chart-2.2.0), 1 day ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
- [spawnia/sailor](https://github.com/spawnia/sailor) ([v0.18.1](https://github.com/spawnia/sailor/releases/tag/v0.18.1), 4 days ago) - A typesafe GraphQL client for PHP
