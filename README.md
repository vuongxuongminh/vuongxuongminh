...
- [hasura-extra/hasura-bundle](https://github.com/hasura-extra/hasura-bundle) ([v1.0.2](https://github.com/hasura-extra/hasura-bundle/releases/tag/v1.0.2), 1 day ago) - Symfony bundle to help handle Hasura action, event, metadata and more.
- [dunglas/mercure](https://github.com/dunglas/mercure) ([helm-chart-0.12.0](https://github.com/dunglas/mercure/releases/tag/helm-chart-0.12.0), 3 weeks ago) - Server-sent live updates: protocol and reference implementation
