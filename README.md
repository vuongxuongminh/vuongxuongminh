...
- [spawnia/sailor](https://github.com/spawnia/sailor) ([v0.23.0](https://github.com/spawnia/sailor/releases/tag/v0.23.0), 1 day ago) - A typesafe GraphQL client for PHP
- [apache/superset](https://github.com/apache/superset) ([superset-helm-chart-0.7.0](https://github.com/apache/superset/releases/tag/superset-helm-chart-0.7.0), 3 days ago) - Apache Superset is a Data Visualization and Data Exploration Platform
- [php-istio/jwt-authentication-bundle](https://github.com/php-istio/jwt-authentication-bundle) ([v2.0.0](https://github.com/php-istio/jwt-authentication-bundle/releases/tag/v2.0.0), 6 days ago) - Symfony bundle help to authenticate request forwarded by Istio sidecar.
