...
- [webonyx/graphql-php](https://github.com/webonyx/graphql-php) ([v15.12.4](https://github.com/webonyx/graphql-php/releases/tag/v15.12.4), 4 days ago) - PHP implementation of the GraphQL specification based on the reference implementation in JavaScript
- [doctrine/orm](https://github.com/doctrine/orm) ([3.2.0](https://github.com/doctrine/orm/releases/tag/3.2.0), 1 month ago) - Doctrine Object Relational Mapper (ORM)
