...
- [hasura-extra/symfony-app](https://github.com/hasura-extra/symfony-app) ([v1.0.0](https://github.com/hasura-extra/symfony-app/releases/tag/v1.0.0), 1 day ago) - Symfony application template (boilerplate) to build the modern web APIs with Hasura graphql engine.
- [hasura-extra/hasura-extra](https://github.com/hasura-extra/hasura-extra) ([v2.0.0](https://github.com/hasura-extra/hasura-extra/releases/tag/v2.0.0), 4 days ago) - PHP libraries to build the modern web APIs with Hasura graphql engine.
