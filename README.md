...
- [hasura-extra/hasura-bundle](https://github.com/hasura-extra/hasura-bundle) ([v1.0.6](https://github.com/hasura-extra/hasura-bundle/releases/tag/v1.0.6), today) - Symfony bundle to help handle Hasura action, event, metadata and more.
